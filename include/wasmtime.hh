...
class ValType {
  ...
  static wasm_valkind_t kind_to_c(ValKind kind) {
    switch (kind) {
      case KindI32: return WASM_I32;
      case KindI64: return WASM_I64;
      case KindF32: return WASM_F32;
      case KindF64: return WASM_F64;
      case KindExternRef: return WASM_ANYREF;
      case KindFuncRef: return WASM_FUNCREF;
      case KindV128: return WASMTIME_V128;
    }
    std::abort();
  }
  ...
  public:
    ...
    ValKind kind() const {
      switch (wasm_valtype_kind(ptr)) {
        case WASM_I32: return KindI32;
        case WASM_I64: return KindI64;
        case WASM_F32: return KindF32;
        case WASM_F64: return KindF64;
        case WASM_ANYREF: return KindExternRef;
        case WASM_FUNCREF: return KindFuncRef;
      }
      std::abort();
    }
  };
...
public:
  ...
  public:
    ...
    Limits limits() const {
      return Limits(wasm_memorytype_limits(ptr));
    }
  };
...
public:
  ...
  public:
    ...
    Limits limits() const {
      return wasm_tabletype_limits(ptr);
    }
...
public:
  Trap(std::string_view msg) : Trap(wasmtime_trap_new(msg.data(), msg.size())) {}
...
public:
  ...
  void interrupt() const {
    wasmtime_interrupt_handle_interrupt(ptr.get());
  }
};
...
public:
  Store(Engine &engine) : ptr(wasmtime_store_new(engine.ptr.get(), nullptr, nullptr)) {}
...
public:
  ...
  ValKind Kind() {
    switch (val.kind) {
      ...
      case WASMTIME_F32: return KindF32;
      case WASMTIME_F64: return KindF64;
      case WASMTIME_FUNCREF: return KindFuncRef;
      case WASMTIME_EXTERNREF: return KindExternRef;
      case WASMTIME_V128: return KindV128;
    }
    std::abort();
  }
...
class Instance {
  ...
  static Extern cvt(wasmtime_extern_t &e) {
    switch (e.kind) {
      case WASMTIME_EXTERN_FUNC: return Func(e.of.func);
      case WASMTIME_EXTERN_GLOBAL: return Global(e.of.global);
      case WASMTIME_EXTERN_MEMORY: return Memory(e.of.memory);
      case WASMTIME_EXTERN_TABLE: return Table(e.of.table);
      case WASMTIME_EXTERN_INSTANCE: return Instance(e.of.instance);
      case WASMTIME_EXTERN_MODULE: return Module(e.of.module);
    }
    std::abort();
  }
